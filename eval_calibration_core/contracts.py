...
def check_expected_minor_range(
    expected_major: int = 0, min_minor: int = 2, max_minor: int = 2
    ...
    """
    ok = is_compatible(
        schema_version, expected_major=expected_major, min_minor=min_minor, max_minor=max_minor
    )
    details = {
